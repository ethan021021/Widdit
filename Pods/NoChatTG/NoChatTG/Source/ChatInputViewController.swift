...
public class ChatInputViewController: UIViewController, ChatInputControllerProtocol {
    ...
    private func addConstraints() {
        ...
        growTextViewLeadingConstraint = NSLayoutConstraint(item: growTextView, attribute: .Leading, relatedBy: .Equal, toItem: inputBar, attribute: .Leading, multiplier: 1, constant: 10)
