...
- (void) setupView:(UIImage*)backgroundImage avatarImage:(UIImage *)avatarImage titleString:(NSString *)titleString subtitleString:(NSString *)subtitleString buttonTitle:(NSString *)buttonTitle scrollHeight:(CGFloat)height type:(MBType)type {
    ...
    // Header
    self.header = [[UIView alloc] initWithFrame:CGRectMake(self.frame.origin.x, self.frame.origin.y, self.frame.size.width, self.frame.size.width)];
...
//    self.headerImageView = [[UIImageView alloc] initWithImage:backgroundImage];
    self.headerImageView.image = backgroundImage;
    self.headerImageView.contentMode = UIViewContentModeScaleAspectFill;

    UIScrollView *scrollView2 = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, 320, 320)];
    scrollView2.backgroundColor = [UIColor greenColor];
    scrollView2.pagingEnabled = YES;
    scrollView2.tag = 2;
    scrollView2.delegate = self;
    scrollView2.contentSize = CGSizeMake(320 * 2, 320);
    [scrollView2 addSubview:self.headerImageView];
...
//    [self.header insertSubview:self.headerImageView aboveSubview:self.headerLabel];
    [self.header insertSubview:scrollView2 aboveSubview:self.headerLabel];
