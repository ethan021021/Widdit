...
public class ChatViewController: UIViewController {
    ...
    private func addConstraints() {
        ...
        view.addConstraint(NSLayoutConstraint(item: topLayoutGuide, attribute: .Bottom, relatedBy: .Equal, toItem: chatItemsContainer, attribute: .Top, multiplier: 1, constant: 250))
