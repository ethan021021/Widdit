...
@property (nonatomic, strong) dispatch_block_t notificationHandler;
@property (nonatomic, strong) dispatch_block_t locationHandler;
...
@property (nonatomic, strong) UIButton *norificationBtn;
