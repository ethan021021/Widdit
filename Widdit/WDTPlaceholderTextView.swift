...
class WDTPlaceholderTextView: UITextView {
    ...
    private func shareInit() {
        NSNotificationCenter.defaultCenter().addObserver(self,
                                                         selector: #selector(WDTPlaceholderTextView.textDidChange),
    ...
    private func updateConstraintsForPlaceholderLabel() {
        ...
        addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("H:|-\(l)-[view]-\(r)-|", options: NSLayoutFormatOptions(rawValue: 10), metrics: nil, views: ["view": placeholderLabel]));
